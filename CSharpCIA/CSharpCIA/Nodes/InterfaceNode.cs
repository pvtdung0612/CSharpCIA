...
namespace CSharpCIA.CSharpCIA.Nodes
{
    public class InterfaceNode : Node
    {
        ...
        public InterfaceNode(string simpleName, string qualifiedName, string originName, string sourcePath, string syntax,
        ...
        {
            if (node == null || !node.Type.Equals(NODE_TYPE.INTERFACE.ToString())) return false;

            var other = (InterfaceNode)node;
