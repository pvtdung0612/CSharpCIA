...
namespace CSharpCIA.CSharpCIA.Nodes
{
    public class ClassNode : Node
    {
        ...
        public ClassNode(string simpleName, string qualifiedName, string originName, string sourcePath, SyntaxTree syntaxTree, SyntaxNode syntaxNode
            , List<string>? attributes, List<string>? modifiers, List<string>? bases)
        ...
        {
            if (node == null || !node.Type.Equals(NODE_TYPE.CLASS.ToString())) return false;

            var other = (ClassNode)node;
