...
namespace CSharpCIA.CSharpCIA.API
{
    internal class Extension
    {
        ...
        {
            // Validation
            if (gexfFilePath is null || !gexfFilePath.EndsWith(".gexf"))
                return false;
            try
            {
        ...
        public static bool ExportNodeAndDependencyToGexf(List<Node> nodes, List<Dependency> dependencies, string gexfFilePath)
        {
            // Validation
            if (gexfFilePath is null || !gexfFilePath.EndsWith(".gexf"))
                return false;
